...
* Студент: [Алена Петерфельд](https://up.htmlacademy.ru/htmlcss/28/user/1391583).
* Наставник: Аня Левченко.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/1391583-technomart-28) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
